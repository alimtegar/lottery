...
const App = () => {
	...
	const [items, setItems] = useState<Item[]>([{ id: nextId, title: '', n: 1 }]);
		...
		<form className="w-full h-full">
			<div className="flex flex-col h-full">
				<div className="form-control w-full mb-2">
					...
					<input type="text" onChange={(e) => setRange(+e.target.value)} value={range} placeholder="0-999" className="input input-bordered w-full text-xs" />
				</div>
				<div className="form-control w-full mb-2">
					<label className="label">
